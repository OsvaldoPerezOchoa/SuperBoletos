...
<body>
	...
	<main class="main">
		<h2 class="main-title">Nuevos Eventos</h2>

	</main>

	<p class="intro">Más Populares</p>
		...
		<div class="row row-cols-3">
			<div class="col">
				<div class="card text-center border-dark  mb-3">
					...
					<div class="card-body">
						<h5 class="card-title">Festival City</h5>
						<hr>
						<p class="card-text">Corregidora, Querétaro</p>
						<p class="card-text">27 de Mayo del 2023</p>
						<hr>
						<a href="evento.html" class="btn btn-primary">Comprar Boletos</a>
					</div>
				</div>
			</div>
			<div class="col">
				<div class="card text-center border-dark mb-3">
					...
					<div class="card-body">
						<h5 class="card-title">Pachuca Rock</h5>
						<hr>
						<p class="card-text">Pachuca, Hidalgo</p>
						<p class="card-text">29 de Abril del 2023</p>
						<hr>
						<a href="evento.html" class="btn btn-primary">Comprar Boletos</a>
					</div>
				</div>
			...
			<div class="col">
				<div class="card text-center border-dark mb-3">
					...
					<div class="card-body">
						<h5 class="card-title">Note Va a Gustar</h5>
						<hr>
						<p class="card-text">León, Guanajuato</p>
						<p class="card-text">27 de Mayo del 2023</p>
						<hr>
						<a href="evento.html" class="btn btn-primary">Comprar Boletos</a>
					</div>
